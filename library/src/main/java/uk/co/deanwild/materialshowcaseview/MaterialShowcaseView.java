...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private TextView mDSwitchLanguageButton;
    ...
    private void init(Context context) {
        ...
        mDSwitchLanguageButton = (TextView) contentView.findViewById(R.id.tv_switch_language);
    }
    ...
    private void setTitleText(CharSequence contentText) {
        if (mTitleTextView != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) mContentTextView.setAlpha(0.9F);
    ...
    private void setSwitchLanguageText(CharSequence language, OnClickListener onClickListener) {
        if (mDSwitchLanguageButton != null && language != null) {
            mDSwitchLanguageButton.setText(language);
            mDSwitchLanguageButton.setOnClickListener(onClickListener);
    ...
    private void setSwitchLanguageTextColor(int textColour) {
        if (mDSwitchLanguageButton != null) {
            mDSwitchLanguageButton.setTextColor(textColour);
        }
    }
    ...
    private void updateSwitchLanguageButton() {
        // hide or show button
        if (mDSwitchLanguageButton != null) {
            if (TextUtils.isEmpty(mDSwitchLanguageButton.getText())) {
                mDSwitchLanguageButton.setVisibility(GONE);
            } else {
                mDSwitchLanguageButton.setVisibility(VISIBLE);
            }
        }
    }
    ...
    public static class Builder {
         ...
         * Set the title text shown on the ShowcaseView.
         */
        public Builder setTarget(ViewTarget viewTarget) {
        ...
        /**
         * Set the switch language text shown on the ShowcaseView.
         */
        public Builder setSwitchLanguageText(int resId, OnClickListener onClickListener) {
            return setSwitchLanguageText(activity.getString(resId), onClickListener);
        }

        public Builder setSwitchLanguageText(CharSequence languageText, OnClickListener onClickListener) {
            showcaseView.setSwitchLanguageText(languageText, onClickListener);
            return this;
        }
        ...
        */
        ...
        public Builder setSwitchLanguageTextColor(int textColour) {
            showcaseView.setSwitchLanguageTextColor(textColour);
            return this;
        }
